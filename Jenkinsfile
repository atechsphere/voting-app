        ...
        stage('Security Scan') {
            steps {
                ...
                script {
                    ...
                    sh '''
                        which trivy || (curl -sf https://raw.githubusercontent.com/aquasecurity/trivy/main/contrib/install.sh | sh -s -- -b /usr/local/bin)
                        
                        # Scan voting-app image
            ...
            steps {
                ...
                script {
                    sh '''
                        ...
                        echo "=== Network Status ==="
                        docker network inspect ${DOCKER_NETWORK} | grep -A 5 "Containers"
